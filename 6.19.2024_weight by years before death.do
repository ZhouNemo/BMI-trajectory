...
use "/Users/x152/Library/CloudStorage/Box-Box/HALSA-Healthy Aging - CLHLS/P32 Weight trajectory & Mortality/Data Analyses/output/analyses.dta", clear
...
graph twoway ///
    ...
    (line mean_weight years_before_death if  BMI_category == 4, lcolor(orange) lpattern(solid) lwidth(vsmall)), ///
