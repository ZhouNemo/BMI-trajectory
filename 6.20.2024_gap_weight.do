...
histogram gap_weight if BMI_category == 3, ///
    title("Histogram of gap_weight for BMI Category Overweight") ///
    xlabel(, grid) ylabel(, grid)
graph export "histogram_gap_weight_BMI_category_Overweight.png", replace

* Generate histogram and export for BMI category 4
histogram gap_weight if BMI_category == 4, ///
    title("Histogram of gap_weight for BMI Category Obese") ///
    xlabel(, grid) ylabel(, grid)
graph export "histogram_gap_weight_BMI_category_Obese.png", replace